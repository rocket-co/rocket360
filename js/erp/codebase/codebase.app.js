...
! function(e) {
        ...
        return a = e, t = null, n = [{
            ...
            value: function() {
                jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.cb.helpers.core", function(e) {
                    ...
                    t.addClass("js-scroll-to-enabled"), jQuery("html, body").animate({
                        scrollTop: jQuery(n).offset().top - r
                    }, o)
                })
            }
        }, {
                ...
                jQuery('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').each(function(e, a) {
                    ...
                    t.addClass("js-click-ripple-enabled").css({
                        ...
                        0 === t.children(".click-ripple").length ? t.prepend('<span class="click-ripple"></span>') : t.children(".click-ripple").removeClass("animate"), (a = t.children(".click-ripple")).height() || a.width() || (n = Math.max(t.outerWidth(), t.outerHeight()), a.css({
                            height: n,
                            width: n
                        })), o = e.pageX - t.offset().left - a.width() / 2, r = e.pageY - t.offset().top - a.height() / 2, a.css({
                            top: r + "px",
                            left: o + "px"
                        }).addClass("animate")
                    })
            ...
            value: function() {
                jQuery(".js-filter:not(.js-filter-enabled)").each(function(e, a) {
                    var t, n = jQuery(a),
                        r = jQuery(".nav-pills", n),
                        l = jQuery("a[data-category-link]", n),
                        i = jQuery("[data-category]", n),
                        s = n.data("speed") || 200;
                    n.addClass("js-filter-enabled"), r.length && jQuery(window).on("resize.cb.helpers", function() {
                        clearTimeout(t), t = setTimeout(function() {
                            o.getWidth() < 768 ? r.addClass("flex-column") : r.removeClass("flex-column")
                        }, 150)
                    }).trigger("resize.cb.helpers"), n.data("numbers") && l.each(function(e, a) {
                        var t = jQuery(a),
                            n = t.data("category-link");
                        "all" === n ? t.append(" (" + i.length + ")") : t.append(" (" + i.filter('[data-category="' + n + '"]').length + ")")
                    }), l.on("click.cb.helpers", function(e) {
                        var a, t = jQuery(e.currentTarget);
                        return t.hasClass("active") || (l.removeClass("active"), t.addClass("active"), "all" === (a = t.data("category-link")) ? i.filter(":visible").length ? i.filter(":visible").fadeOut(s, function() {
                            i.fadeIn(s)
    ...
    var s = function() {
        ...
        return a = e, (t = [{
            ...
            key: "_uiHandleScroll",
            value: function() {
                this._lPage.hasClass("side-scroll") ? (this._lSidebar.length > 0 && !this._lSidebarScroll && (this._lSidebarScroll = new SimpleBar(this._lSidebar[0]), jQuery(".simplebar-content-wrapper", this._lSidebar).scrollLock("enable")), this._lSideOverlay.length > 0 && !this._lSideOverlayScroll && (this._lSideOverlayScroll = new SimpleBar(this._lSideOverlay[0]), jQuery(".simplebar-content-wrapper", this._lSideOverlay).scrollLock("enable"))) : (this._lSidebar && this._lSidebarScroll && (jQuery(".simplebar-content-wrapper", this._lSidebar).scrollLock("disable"), this._lSidebarScroll.unMount(), this._lSidebarScroll = null, this._lSidebar.removeAttr("data-simplebar").html(jQuery(".simplebar-content", this._lSidebar).html())), this._lSideOverlay && this._lSideOverlayScroll && (jQuery(".simplebar-content-wrapper", this._lSideOverlay).scrollLock("disable"), this._lSideOverlayScroll.unMount(), this._lSideOverlayScroll = null, this._lSideOverlay.removeAttr("data-simplebar").html(jQuery(".simplebar-content", this._lSideOverlay).html())))
            }
        }, {
            key: "_uiHandleMain",
            value: function() {
            ...
            value: function() {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').parent("li").addClass("active"), this._lPage.off("click.cb.themes"), this._lPage.on("click.cb.themes", '[data-toggle="theme"]', function(t) {
                    ...
                    var n = jQuery(t.currentTarget),
                        r = n.data("theme");
                    jQuery('[data-toggle="theme"]').parent("li").removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + r + '"]').parent("li").addClass("active"), o.updateTheme(e, r), e = jQuery("#css-theme"), a && Cookies.set("cbThemeName", r, {
                        expires: 7
                    }), n.blur()
                })
            }
            ...
            value: function() {
                var e, a, t, n = this,
                    ...
                    r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "init",
                    l = this,
                    ...
                    u = {
                        init: function() {
                            ...
                            }), l._lPage.off("click.cb.blocks"), l._lPage.on("click.cb.blocks", '[data-toggle="block-option"]', function(e) {
                ...
                "init" === r ? u[r]() : (e = o instanceof jQuery ? o : jQuery(o)).length && (a = jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]', e), t = jQuery('[data-toggle="block-option"][data-action="content_toggle"]', e), u[r] && u[r]())
            }
        }, {
            key: "init",
            value: function() {
