...
$('document').ready(function() {
	...
	$(".js-play-popup-video-local").click(function(event){
		event.preventDefault();
		var url = $(this).attr("href");
		$(".video_popup .iframe_container").html('<video controls autoplay><source src="'+url+'" type="video/mp4"></video>');
		$(".video_popup, .overlay").fadeIn(300);
	});


	// Close video popup
	//	$(".video_popup .close, .overlay").click(function(e){ funcion cuando click sobre el video.
